...
import com.graduation.design.client.R.string;
 ...
 * well.
 */
public class LoginActivity extends Activity implements OnTextListener{
	/**
	...
	private void initViews() {
		titleBarView = (TitleBarView)findViewById(R.id.titleLogin);
		titleBarView.setOnTextListener(this);
	}
